...
def build_get_turn_tool(snapshot: list[dict[str, Any]]) -> FunctionTool:
    ...
    return FunctionTool(
        ...
        parameters=pydantic_to_openai_tool_schema(GetTurnArgs),
        fn=_fn,
    )
...
def build_get_gt_info_tool(gt_info: dict[str, Any]) -> FunctionTool:
    ...
    return FunctionTool(
        ...
        parameters=pydantic_to_openai_tool_schema(GetGtInfoArgs),
        fn=_fn,
    )
...
def build_get_trajectory_summary_tool(summary: str, total_turns: int) -> FunctionTool:
    ...
    return FunctionTool(
        ...
        parameters=pydantic_to_openai_tool_schema(GetTrajectorySummaryArgs),
        fn=_fn,
    )
...
def build_submit_divergence_report_tool() -> FunctionTool:
    ...
    return FunctionTool(
        ...
        parameters=pydantic_to_openai_tool_schema(SubmitDivergenceReportArgs),
        fn=_fn,
