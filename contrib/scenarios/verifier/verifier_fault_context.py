    ...
    api.register_tool(
        FunctionTool(
            ...
            description=(
                ...
                "observation windows. Use this as the starting point — then "
                "call get_fault_kind_doc(fault_kind) for the mechanism / "
                "signatures / propagation reference, and independently "
                "confirm via parquet data that the injection materialized."
            ),
