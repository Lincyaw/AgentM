"""Context injection for WorkGraph workers.

Canonical implementation shared by all WorkGraph agents — each agent
directory holds a relative symlink to this file, so ``local:
workgraph_context`` resolves per agent while the logic lives once.
"""
...
MANIFEST = ExtensionManifest(
    ...
    description="Inject WorkGraph task context into a worker system prompt.",
