...
import (
	...
	"github.com/AoyangSpace/agentm-terminal/internal/cagent/tools/lifecycle"
)
...
func NewRemoteToolset(name, urlString, transport string, headers map[string]string, oauthConfig *RemoteOAuthConfig, policy ...lifecycle.Policy) *Toolset {
