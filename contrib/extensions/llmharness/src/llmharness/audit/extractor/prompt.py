"""System prompt for the v3.1 extractor child session (single-tool flow).
...
with embedded ``refs[]``. It does not judge drift; the auditor (later
phase) reads the graph this prompt produces.
