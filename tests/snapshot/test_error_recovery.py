...
class TestAbortTask:
    ...
    @pytest.fixture(autouse=True)
    def _bind_task_manager(self, task_manager_with_running_task: TaskManager) -> None:
        self._orig = orch_tools._task_manager
        orch_tools._task_manager = task_manager_with_running_task
    ...
    def test_abort_sets_failed_status(self) -> None:
        ...
        orch_tools.abort_task("task-running-001", "timeout")
