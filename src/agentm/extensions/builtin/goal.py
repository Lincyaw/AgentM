...
_CHECKER_PROMPT_TEMPLATE: Final[str] = (
    ...
    "The task's requirements are the authority, not the repository's "
    "current state. Do not reject because existing code or tests still "
    "encode behavior the task is changing — an in-repo artifact that "
    "contradicts the task is stale, not ground truth. Judge only against "
