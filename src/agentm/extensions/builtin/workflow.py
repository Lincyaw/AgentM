...
from agentm.extensions.builtin._workflow.journal_tools import (
    JournalTools,
    ...
    def install(self) -> None:
        ...
        self._api.register_tool(
            FunctionTool(
                ...
                description=(
                    ...
                    "Edges are the precise subset of the dataflow, not proof "
                    "there are no other dependencies: a result transformed "
                    "before interpolation leaves no verbatim edge, and a node "
                    "with no verbatim parent at all falls back to conservative "
                    "order_candidates. Use this to trace a wrong result back "
                    "to its upstream nodes before deciding what to invalidate."
                ),
                parameters=WorkflowLineageParams,
        ...
        self._api.register_tool(
            FunctionTool(
                ...
                parameters=WorkflowInvalidateParams,
