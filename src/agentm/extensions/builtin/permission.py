"""Policy-gate atom for the ``extensions.builtin.permission`` row.
...
from agentm.core.abi import AtomAPI, AtomInstallPriority, ToolCallEvent
...
class _PermissionRuntime:
    def __init__(self, api: AtomAPI, config: PermissionConfig) -> None:
        self._api = api
