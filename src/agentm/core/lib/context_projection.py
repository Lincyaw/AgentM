"""Default provider-context projection over the active trajectory chain."""
...
from agentm.core.abi.messages import AgentMessage, MessageMeta, TextContent, UserMessage
...
def _node_message(
    ...
    *,
    ...
    return UserMessage(
        role="user",
        content=[TextContent(type="text", text=f"[content_ref:{node.content_ref}]")],
...
__all__ = ["ExactNodeChainProjection"]
