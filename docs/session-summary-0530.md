...
**文件**：
- `contrib/evals/rescue_window/src/rescue_window/cli.py`
...
状态：3 commits 在 worktree 分支，已 cherry-pick 到 rescue-window worktree。
待 merge 到 main。
...
返回 error result 告诉 agent "拆分到多个 turn"。rescue-window CLI 里设了 20。
